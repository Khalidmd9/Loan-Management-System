...
public interface ILoanRepository {
    ...
    double calculateInterest(String loanId, double principalAmount, double interestRate, int loanTerm) throws InvalidLoanException;
    void loanStatus(String loanId) throws InvalidLoanException;
    double calculateEMI(String loanId) throws InvalidLoanException;
    double calculateEMI(String loanId, double principalAmount, double interestRate, int loanTerm) throws InvalidLoanException;
